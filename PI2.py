...
horario = formag.selectbox(
    'Horário:',
    ('07:40 - 08:30', '08:30 - 09:20', '09:20 - 10:10', '10:20 - 11:10', '11:10 - 12:00', '13:00 - 13:50',
     '13:50 - 14:40', '14:40 - 15:30', '15:40 - 16:30', '16:30 - 17:20', '17:20 - 18:00')
...
if btnregistrar:
    ...
    if len(dados_usuario) == 0:
        ...
        if tiporeg == "Agendamento":
            ...
            cur.execute(
                "INSERT into tbl_agenda (cod_agendamento, sala, nome_usuario, data, horario, link) values (?,?,?,?,?,?)",
                (cod_ag, sala, dados_usuario[0][1], dtagendamento, horario, link))
            con.commit()
...
with tab3:
    ...
    if btncaduser:
        ...
        if dados_usuario[0][3] == "Administrador":
            cur.execute("INSERT into tbl_usuarios (cpf, nome_usuario, senha_usuario, perfil_usuario) values (?,?,?,?)",
                        (cpf, nome, cadsenha, perfil,))
            con.commit()
        else:
